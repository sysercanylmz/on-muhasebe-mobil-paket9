...
def init_db():
    ...
    with get_connection() as conn:
        ...
        CREATE TABLE IF NOT EXISTS islem_kayitlari (
            ...
            belge_no TEXT,
            belge_tarihi TEXT,
            kdv_hesap_tipi TEXT DEFAULT 'dahil',
        ...
        if not _column_exists(conn, "islem_kayitlari", "kdv_hesap_tipi"):
            cur.execute("ALTER TABLE islem_kayitlari ADD COLUMN kdv_hesap_tipi TEXT DEFAULT 'dahil'")
