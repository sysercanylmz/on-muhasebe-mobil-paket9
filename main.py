...
from app.screens.vergi_screen import VergiScreen
...
class YNBOnMuhasebeMobileApp(App):
    ...
    def build(self):
        ...
        self.manager.add_widget(VergiScreen(name="vergi"))
    ...
    def _open_more_menu(self):
        ...
        for text, screen in [("Kategoriler", "kategoriler"), ("Raporlar", "raporlar"), ("Vergi Tahmini", "vergi"), ("Yedek", "yedek")]:
